...
from adaptive_horizon.visualization.plotting import plot_trajectory, plot_lyapunov_exponents, plot_trajectory_heatmap
...
def main():
    ...
    if args.mode == "global":
        ...
        lyap = compute_local_lyapunov(lorenz_trajectory, window=args.window)
        plot_lyapunov_exponents(lyap, window=args.window)
        plot_trajectory_heatmap(lorenz_trajectory, lyap, args.window)
